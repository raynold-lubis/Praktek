...
<body>
    ...
    include "nav.php"
        ...
        ?>
    <div class="wrapper">
        <h1>Data Petugas Pendaftaran</h1>
        <form action="data_petugas_pendaftaran.php" method="get">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    if (isset($_GET['search'])) {
                        $search = $_GET["search"];
                        $sql = "SELECT * FROM users WHERE user = 'petugas_pendaftaran' AND nama like '%$search%'";
                    } else {
                        // Prepare a select statement
                        $sql = "SELECT * FROM users WHERE user = 'petugas_pendaftaran'";
                    }
